...
<div class="span12">
	<div class="widget-box">
		<div class="widget-title">
			...
			<h5>临时素材列表</h5>
			<a class="btn btn-info label" href="<?= Url::to(['tmp-material/form','pid' => Yii::$app->controller->pid]);?>">创建</a>
		</div>
		<div class="widget-content">
			...
			<input type="hidden" class="delete-action" value="<?= Url::to(['tmp-material/delete','pid' => Yii::$app->controller->pid]);?>" />
